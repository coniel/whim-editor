...
**Note:** Version bump only for package @braindrop-editor/plugin-equation
...
* **plugin-equation:** set value to properties.expression on change ([ced48cd](https://github.com/coniel/slash/commit/ced48cd9ae994be6da2e7d72f351c521c6d8b41a))
...
* **plugin-equation:** switch Done button type to button ([05a83e3](https://github.com/coniel/slash/commit/05a83e3a8f73149030fbfd53f40cd74337f51bc2))
